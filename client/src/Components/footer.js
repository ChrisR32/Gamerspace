...
<span id="logo">
<img src={FooterImg} className="footer-logo" alt="Gamerspace Logo"/>
</span>
</div>
    ...
    <div class="row my-4 my-md-5">
        ...
        <img src={FooterLogo} className="footer-name" alt="Gamerspace Logo"/>
...
<div class="lower-footer">
    <div class="container mt-3 mt-md-5 py-3">
        <div class="row">
            ...
            <a href="#">&copy; Copyright 2020</a> | website developed by <a href="https://github.com/ChrisR32">Christopher Morris</a> and <a href="https://github.com/mmolloy88">Matthew Molloy</a>
            </small>
